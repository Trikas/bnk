    ...
    <div class="main-content main-content_height container-fluid">
        <div class="row">
            <div class="col col--lg-12" style="margin-top:10px;">
                <h2>Денежные переводы - оформление новых (Этап 2 из 3)</h2>
                <div class="alertblue" style="margin-top:20px;margin-bottom:20px;">
                    <p>Пожалуйста, проверьте правильность введенной информации перед выполнением платежа.</p>
                </div>
                    <div class="formtable">
                    ...
                    <div class="formbut" style="margin-top:10px;">
                        <button type="button"><a href="#" onclick="window.history.back();">Изменить</a></button>
                        <form action="/payment/finish" method="post" style="display: contents;">
                            @csrf
                            <input type="hidden" name="conditions" value="1">
                            <button type="submit" style="margin-left:40px;">Завершить</button>
                        </form>
                    </div>
            </div>
        </div>
